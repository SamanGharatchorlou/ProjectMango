...
//Text::Text(const BasicString& text, const StringBuffer32& font, int ptSize, SDL_Color colour)
//{
//	BasicString path = FileManager::Get()->findFile(FileManager::Font, font.c_str());
...
//
//
//void Text::init(const BasicString& text, const StringBuffer32& font, int ptSize, SDL_Color colour)
//{
//	BasicString path = FileManager::Get()->findFile(FileManager::Font, font.c_str());
//	mFont.loadFromFile(path, ptSize);
//
